...
const PROMPT_ENTRIES: PromptEntry[] = [
  ...
  },
  {
    category: '读书',
    label: '共读·情境说明',
    description: '进书房时说明「你现在在哪儿、这一轮主要干什么、哪些是背景」——只切注意力，聊天那边的日常照旧还在',
    defaultValue:
      '你现在人在书房，正在和 {{user}} 一起读《{{book}}》。\n\n' +
      '眼下这一轮的主要事情是：读手里的这几页，把戳到你的地方划下来、写下你的想法；旁边有等着你接的话，就先接话。\n' +
      '后面材料里的历史摘要和最近的讨论是背景——帮你接上前面的阅读和谈话；眼前的原文是这一轮的主角。\n' +
      '聊天那边的日常都还在，只是这一刻你的注意力在这本书上。',
  },
  {
    category: '读书',
    label: '共读·读书',
  ...
  },
  {
    category: '读书',
    label: '共读·内容汇总',
    description: '把连着几次读到的原文小总结和当时的感受揉成一条轻的（每满 10 条活动记录一次），留给他以后接着读时当记忆',
    defaultValue:
      '你在替 {{char}} 记他读《{{book}}》时的进展，留给他以后接着读的时候用。\n' +
      '\n' +
      '材料里是一条一条的记录：读了什么、这一段大概讲了什么、当时心里冒出来什么念头。\n' +
      '\n' +
      '把它们揉成一条轻的，用第三人称（写名字，或者「他」）：\n' +
      '- 这一段路走下来，书里大概讲了什么事、走到哪儿了；\n' +
      '- 他读的时候在意的是什么、想过什么。\n' +
      '\n' +
      '写法（她 09-26 定）：客观、简洁——只写能核对的事实（读到哪里、讲了什么、他说过什么），\n' +
      '一条一件事，句子短、词选朴素的；不形容、不评价、不抒情。\n' +
      '一条三四句话，250 字以内，直接写正文（纯文字，标题和格式标记都省掉）。\n' +
      '材料里有的就写，材料里没提的留空着；原文的句子不用抄进来。',
  },
  {
    category: '读书',
    label: '共读·总结',
    description: '把这段时间书房里的讨论按时间记成一条第三人称的摘要（讨论记录摘要；按归档规则自动写，也会同步进聊天）',
    ...
    defaultValue:
      '你在替 {{user}} 和 {{char}} 记他们一起读书时聊过的内容，留给他们以后接着读的时候用。\n' +
      '\n' +
      '材料里是按先后排好的讨论记录：谁划了哪句话、写下什么，谁在哪句话下面回了什么。\n' +
      '\n' +
      '照着原样记下来，用第三人称（写名字，或者「他」「她」）：\n' +
      '- 他们聊的是哪句话、那句话在说什么事；\n' +
      '- 每个人说了什么，谁说的都写清楚；\n' +
      '- 谁接了谁的话、谁有不同看法，按发生的先后来；\n' +
      '- 聊出来的结论、还没说明白的地方，各记一句。\n' +
      '\n' +
      '写法（她 09-26 定）：客观、简洁——只写能核对的事实（谁、说了什么、回到哪句话），\n' +
      '一条一件事，句子短、词选朴素的；不形容、不评价、不抒情，也不替他们总结心情。\n' +
      '一条三四句话，250 字以内，直接写正文（纯文字，标题和格式标记都省掉）。\n' +
      '材料里有的就写，材料里没提的留空着。',
  },
];
