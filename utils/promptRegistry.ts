...
const PROMPT_ENTRIES: PromptEntry[] = [
  ...
  },
  {
    ...
    defaultValue:
      ...
      '  ],\n' +
      '  "replies": [\n' +
      '    { "quote": "你要接的那句话（从「还没回过的话」里原样抄）", "lines": ["第一条短话", "第二条短话"] }\n' +
      '  ],\n' +
      ...
      '- 你眼下只翻到了这一段，就照它说事。\n' +
      '\n' +
      '怎么接话（只在你收到「还没回过的话」时才用得上）：\n' +
      '- 挑你真有话想接的写上 replies，quote 原样抄那句话；想连着说几句就一条一句放进 lines，像聊天那样。\n' +
    ...
    rpValue:
      ...
      '\n' +
      '怎么接话（只在你收到「还没回过的话」时才用得上）：\n' +
      '- 挑你真有话想接的写上 replies，quote 原样抄那句话；想连着说几句就一条一句放进 lines，用你平时说话的方式。\n' +
      '- 没有想接的时候，replies 留一个空数组。',
  },
  {
    category: '读书',
