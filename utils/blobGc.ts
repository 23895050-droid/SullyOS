...
// | image_receipts 表 | 相机/相册「近期接收」原图（fork 专属 store：blobRef 字段，
// |                    | 不入清单会被当孤儿删掉全部相机原图） | 分页逐行 |
//
...
//   STORE_GUIDEBOOK / STORE_LIFE_SIM / pixel_home_assets / STORE_IMAGE_RECEIPTS）。
// image_receipts 是 fork 自己加的表（相机/相册近期接收原图），上游清单没有它——
